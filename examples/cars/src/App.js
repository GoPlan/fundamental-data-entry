...
function App() {
    let data = [
        ...
        {
            brand: "Volkswagen", color: "white", model: "Golf7", price: 8500, "year": 2019, "id": 3
        },
        {
        ...
        {
            brand: "Volkswagen", color: "white", model: "Golf7", price: 8500, "year": 2019, "id": 15
        },
        {
    ...
    return (
        <div className="App max-w-3xl mx-auto h-full">
            ...
            <div className="border-2 border-yellow-500 my-5 p-3">
                Your current budget is:<span className="">{budget}</span>
            </div>
            ...
            <div className="grid grid-cols-3 my-3 gap-3">
                {
                    data.map(
                        (el) => {
                            return (
                                // <div key={el.id}>
                                //     <span className="font-bold">{el.brand.toUpperCase()}</span>
                                // </div>
